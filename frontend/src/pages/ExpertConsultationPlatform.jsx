  ...
  return (
    ...
    >
      ...
      <Card className="flex flex-col md:flex-row items-center bg-white text-black p-8 rounded-xl shadow-md gap-6">
        ...
        <img
          src="https://images.unsplash.com/photo-1615800001815-49ad9d5b11cb"
          alt="Farmer"
      ...
      <Card className="bg-white text-black p-8 rounded-xl shadow-md text-center space-y-4">
        ...
        <Button className="bg-green-800 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-all">
          Get Started Now
        </Button>
      </Card>
    </div>
