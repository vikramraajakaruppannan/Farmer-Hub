      ...
      <Card className="flex flex-col md:flex-row justify-between p-6 mb-10">
        <div className="md:w-2/3">
          ...
          <p className="text-black mb-4">
            Our advanced AI system uses deep learning algorithms to analyze images of plant leaves and identify diseases with high accuracy. By processing thousands of data points, it can detect early signs of diseases, helping farmers take preventive action before the problem spreads.
          </p>
