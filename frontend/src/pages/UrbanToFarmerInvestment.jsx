  ...
  return (
    <div className="text-black min-h-screen px-4 sm:px-8 py-10" style={{ backgroundColor: "#A6E483" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-gray-100 p-6 text-black h-full">
            ...
            <div className="flex justify-center gap-4 my-4">
              <h2 className="bg-white text-black px-4 py-2 rounded shadow">Invest ₹5,000</h2>
              <h2 className="bg-white text-black px-4 py-2 rounded shadow">Invest ₹10,000</h2>
            </div>
      ...
      <Card className="bg-white text-black p-8 text-center max-w-4xl mx-auto mb-10">
        ...
        <Button className="bg-green-800 text-white px-6 py-2 rounded-full hover:bg-green-700">
          Get Started Now
        </Button>
      </Card>
    </div>
