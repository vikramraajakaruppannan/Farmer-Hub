...
const Dashboard = () => {
  ...
  // Initialize user, session, and notifications
  useEffect(() => {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          ...
          (error) => {
            ...
            setWeatherLoading(false);
            fetchWeather(11.016844, 76.955833);
          },
          { timeout: 10000 }
        );
      } else {
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow border-t-4 border-t-red-500 rounded-lg">
            <CardContent className="p-4 sm:p-5">
              ...
              <Link
                ...
                aria-label="Start AI Crop Disease Scanner"
              >
                Scan Now
              </Link>
            </CardContent>
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow border-t-4 border-t-blue-500 rounded-lg">
            <CardContent className="p-4 sm:p-5">
              ...
              <Link
                ...
                aria-label="Start Farmer-to-Farmer Exchange"
              >
                Start Trading
              </Link>
            </CardContent>
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow border-t-4 border-t-purple-500 rounded-lg">
            <CardContent className="p-4 sm:p-5">
              ...
              <Link
                ...
                aria-label="Start Expert Consultation"
              >
                Ask an Expert
              </Link>
            </CardContent>
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow rounded-lg">
            <CardContent className="p-4 sm:p-5">
              ...
              <Link
                ...
                aria-label="Start Urban-to-Farmer Investment"
              >
                Invest Now
              </Link>
            </CardContent>
          ...
          <Card className="overflow-hidden shadow-sm hover:shadow-md transition-shadow rounded-lg">
            <CardContent className="p-4 sm:p-5">
              ...
              <Link
                ...
                aria-label="Start Smart Agri Supply Chain"
              >
                Find Buyers
              </Link>
            </CardContent>
